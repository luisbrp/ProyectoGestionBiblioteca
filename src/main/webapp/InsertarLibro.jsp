...
<html>
  <head>
    <title>Formulario de insercion de libro</title>
    <meta charset="utf-8">
  ...
  <body>
    <div class="container">
      <h2>Formulario de insercion de libro</h2>
      <form action="InsertarLibro" method="post">
        ...
        <div class="form-group">
          <label for="num_pag">Numero de paginas:</label>
  ...
  <input type="text" name="id_editorial" required class="form-control"
        oninvalid="this.setCustomValidity('Por favor, ingresa una contraseña valida')"
